...
public class SOSServiceImpl extends IService {
	 ...
	 */
	@Override
	public IServiceInfo getInfo(final IProgressMonitor monitor) throws IOException {
	...
	class SOSServiceInfo extends IServiceInfo {
		...
		public SOSServiceInfo(final SOSDataStore ds) throws IOException {
			this.datastore = ds;
			capabilities = SOSDataStoreFactory.getInstance().getCapabilities(url);
		}
